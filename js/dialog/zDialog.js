...
'
    ...
    if (!div) {
        ...
        $id(this.InvokeElementId).parentNode.insertBefore(div,$id(this.InvokeElementId));
    }
...
Dialog.prototype.close = function () {
    ...
    if (this.InvokeElementId) {
        ...
        if (isIE) {
            ...
            thisdialogDiv.parentNode.insertBefore(fragment,thisdialogDiv);
        } else {
            //document.getElementsByTagName("BODY")[0].appendChild(innerElement)
            thisdialogDiv.parentNode.insertBefore(innerElement,thisdialogDiv);
        }
